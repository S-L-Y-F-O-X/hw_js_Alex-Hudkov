...
function calculateArea(figure, ...items) {
    let area;
    ...
    if (figure === 'rectangle') {
        ...
        return "I can't acidify this figure";
    }
    return area;
}
...
//  Або такий варіант =)
function elementsTwo(...arr) {
    for (let element in arr) {
        console.log(arr[element]);
    }
}

elementsTwo(...[-11, 'text', true, 5]);
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Цікавить яка різниця в цих двух функціях?!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// !!!!!!!!!! Начебто у першому випадку робиться псевдомасив, але нащо - незрозуміло! що я можу з ним далі зробити?!!!!!!!!!!!
// !!!!!!!!!! текст в середині нього все одно знаходиться під нульовим індексом, не розділяючи кожне слово по індексам.!!!!!!!!
function paragraphTwo(t) {
    document.write(`<p>${t}</p>`)
    // console.log(t)
}

paragraphTwo("Довільний текст");

// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// - створити функцію яка створює ul з трьома елементами li. Текст li задати через аргумент всім однаковий
function ulOne(textLi) {
    document.write(`<ul>`);
        for (let i = 0; i < 3; i++) {
